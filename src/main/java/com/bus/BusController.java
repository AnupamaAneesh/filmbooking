...
//	Exception handling
	...
	//Add Movie
		@GetMapping("/addmovie")
		public String AddNewMovie(Model m) {

			m.addAttribute("menu", "addmovie");
			return "add-movie";
		}
		
//		Movie save process
		@PostMapping("/add-new-movie")
		public String AddNewMovieAction(@ModelAttribute("movies_details") MovieDetails movies_details) {
			dao.savemovie(movies_details);
